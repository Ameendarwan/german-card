    ...
    <section className="mb-12 mt-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-text leading-relaxed mb-4 font-medium">
          ...
          operator. His contact details can be found in the section "Note on the
          responsible body" in this privacy policy.
        </p>
        ...
        <p className="text-text leading-relaxed mb-4 font-medium">
          ...
          form. Other data is collected automatically or after your consent when
          you visit the website by our IT systems. These are mainly technical
          data (e.g. Internet browser, operating system or time of page view).
        ...
        <p className="text-text leading-relaxed mb-4 font-medium">
          ...
          data under certain circumstances. Furthermore, you have a right of
